...
class FactExtractor:
    ...
    def extract_facts(self, case_text: str, template, extraction_schema: Dict[str, Any]):
        """
        ...
        try:
            ...
            # Create ExtractedFacts dataclass instance
            extracted_facts = ExtractedFacts(
                template_id=template_id,
                template_label=template_label,
                tier_1_determinative=facts_dict.get('tier_1_determinative', {}),
                tier_2_material=facts_dict.get('tier_2_material', {}),
                tier_3_contextual=facts_dict.get('tier_3_contextual', {}),
                tier_4_procedural=facts_dict.get('tier_4_procedural', {}),
                residual_details=facts_dict.get('residual_details', {}),
                extraction_confidence=1.0,  # Using structured output guarantees completion
...
**EXTRACTION RULES**:
1. Provide short, concise answers using keywords or phrases
