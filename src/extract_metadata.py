...
"""
    ...
    def extract_metadata_and_facts(self, case_text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            ontology_matcher = OntologyMatcher("ontology_schema.json")
            ...
            self.logger.info(f"Step 3: Creating extraction schema for template: {template.label}")
            ...
            result = {
                ...
                'extracted_facts': asdict(extracted_facts),
